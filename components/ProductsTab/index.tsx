      ...
      <div className="mx-auto max-w-c-1315 px-4 md:px-8 xl:px-0 mb-5">
                  ...
                  <div className="animate_top mx-auto text-center">
                    <SectionHeader
                     headerInfo={{
                      title: "Our Products",
                      subtitle: "Flagship & Tailored Solutions",
                      description:
                        "At Weperch, we combine innovation and expertise to create digital products that empower businesses to succeed. Our flagship offerings are designed for high performance, scalability, and flexibility, ensuring that every solution is uniquely crafted to meet the demands of a dynamic marketplace. Explore our range of products and discover how our custom solutions can drive sustainable growth for your business.",
                    }}
        ...
        <div className="relative mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          >
            ...
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                <button className="text-sm font-medium text-black dark:text-white xl:text-regular">
                  Invox - Streamlined Invoice Generator for Businesses, Brands, & Freelancers. 
                </button>
              </div>
            </div>
            {/* <div
            ...
            >
              ...
              <div className="md:w-3/5 lg:w-auto">
                <button className="text-sm font-medium text-black dark:text-white xl:text-regular">
                  Easy Integration with our core business-facing APIs
                </button>
              </div>
            </div> */}
            {/* <div
          ...
          >
            {productsTabData.map((feature, key) => (
              <div
                className={feature.id === currentTab ? "block" : "hidden"}
                key={key}
              >
                <ProductsTabItem featureTab={feature} />
              </div>
            ))}
          </motion.div>
          {/* <!-- Tab Content End --> */}
