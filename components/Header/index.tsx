  ...
  return (
    <header
      className={`fixed left-0 top-0 z-99999 w-full py-7 ${
        stickyMenu
          ? "bg-transparent !py-4 transition duration-100"
          : ""
      }`}
    >
      <div className="relative mx-auto max-w-c-1390 items-center justify-between px-4 md:px-8 xl:flex 2xl:px-0">
        ...
        >
          <nav className={`bg-black rounded-full px-7.5 py-4.5 ${
        stickyMenu
          ? "bg-transparent transition duration-100 backdrop-blur-lg shadow"
          : ""
      } ${navigationOpen ? "bg-transparent shadow-none" : ""}`}>
